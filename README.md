**Скріни виконання кроку 6**:

- [list](https://ibb.co/M7SSxCQ)
- [get](https://ibb.co/DKr9jYp)
- [add](https://ibb.co/j6KN1Lv)
- [remove](https://ibb.co/hDkjD6Z)
...
- Створи змінну `contactsPath` і запиши в неї шлях до файлу `contacts.json`. Для
...
Так само, ви можете використовувати модуль
[commander](https://www.npmjs.com/package/commander) для парсинга аргументів
командного рядка. Це більш популярна альтернатива модуля `yargs`
...
README.md. Створіть цей файл в корені проекту.
